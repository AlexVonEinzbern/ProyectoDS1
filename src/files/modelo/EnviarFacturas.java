...
public class EnviarFacturas {
    ...
    public static void enviarConGMail(String destinatario, String asunto, String cuerpo,String idFactura,String nombreCliente) {
...
*/
        ...
        Authenticator auth = new Authenticator() {
            public PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(remitente, "password1234.");
            }
        };
